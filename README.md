# Real Time Gloria Paneton — Real Time Ad
...
> El sistema de reproducción carga el aviso dentro de un `iframe` y lo estira a pantalla completa. El aviso está diseñado en base `3584×864` y se ajusta solo a cualquier resolución.
